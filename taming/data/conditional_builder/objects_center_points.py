...
class ObjectsCenterPointsConditionalBuilder:
    ...
    def embedding_dim(self) -> int:
        ...
        return self.no_max_objects * self.object_descriptor_length + extra_length # 30*3+2
    ...
    def tokenize_coordinates(self, x: float, y: float) -> int:
        ...
        y_discrete = int(round(y * (self.no_sections - 1))) # self.no_sections=90
    ...
    def build(self, annotations: List, crop_coordinates: Optional[BoundingBox] = None, horizontal_flip: bool = False) \
        ...
        flattened = [token for tuple_ in object_tuples for token in tuple_] + extra # extra encode crop_coordinates
